...
addFormEl.className = 'form-inline mb-2'; // см. документацию bootstrap
addFormEl.innerHTML = `
...
addFormEl.addEventListener('submit', function (ev) {
    ...
    const type = typeEl.value; // исходя из этого значение создаёте разные типы постов
    console.log(type);
    posts.push({
        value,
        type,
...
function rebuildList(containerEl, items) {
    ...
    for (const item of items) {
        ...
        // TODO: и т.д. для других типов постов
